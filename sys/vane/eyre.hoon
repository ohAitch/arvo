...
++  pest                                                ::  result
  ...
  $%  {$$ p/httr}                                       ::  direct response
      {$red $~}                                         ::  parent redirect
      {$bake p/whir q/mark r/beam}                      ::  ford request
      {$boil p/whir q/mark r/beam s/coin}               ::  ford ren request
      {$js p/@t}                                        ::  script
      {$json p/json}                                    ::  data
  ...
  ++  handle
    ...
    ++  resolve
      ...
      ?-  -.pez
          ...
          $bake
        =+  `[wir=whir mar=mark bem=beam]`+.pez
        =.  -.bem  (norm-beak -.bem)
        %^  exec-live  wir  -.bem
        `silk:ford`[%alts [%boil mar *coin bem] [%bake mar bem] ~]
      ::
          $boil
        =+  `[wir=whir mar=mark bem=beam arg=coin]`+.pez
        =.  -.bem  (norm-beak -.bem)
    ...
    ++  process-parsed
      ...
      ?-    -.hem
        ...
        =+  ?-  -.hem
              $read  [%bake wir p.hem bem]  :: XX error on arg?
              $rend  [%boil wir p.hem bem arg]
            ==
